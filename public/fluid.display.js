  ...
  var FluidDisplayASCII = function(fluid) {
    ...
    this.bindElement = function(DOMElement) {
      ...
      if (DOMElement.parentElement === null) {
        throw new Error('bindElement must be given an element that has been attached to the DOM!');
      }
      ...
      DOMElement.onmousemove = (function() {
        ...
        return function(e) {
          // possible optimization: only do this when window has resized...
          updateOrigin();
          ...
          if (e.pageX || e.pageY) {
            mouse_cur.x = e.pageX - origin.x;
            mouse_cur.y = e.pageY - origin.y;
          }
          else if (e.clientX || e.clientY) {
            mouse_cur.x = e.clientX + doc_body.scrollLeft + doc_element.scrollLeft - origin.x;
            mouse_cur.y = e.clientY + doc_body.scrollTop + doc_element.scrollTop - origin.y;
          }
